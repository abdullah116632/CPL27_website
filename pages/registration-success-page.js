    ...
    <main className="grid min-h-dvh place-items-center bg-[#021522] px-4 py-16 text-white">
      <div className={container}>
        <div className="mx-auto grid max-w-[560px] place-items-center rounded-2xl border border-[#c6ae8c]/70 bg-[#021827e8] p-8 text-center shadow-2xl backdrop-blur-md min-[680px]:p-12">
          <i className="grid size-20 place-items-center rounded-full bg-[#6ca82c] text-5xl not-italic">
            <FaCircleCheck />
          </i>
          <h1 className="mt-6 font-[Impact,Arial_Narrow,sans-serif] text-[34px] leading-none tracking-wide min-[680px]:text-[44px]">
            REGISTRATION <span className="text-[#78b82e]">SUCCESSFUL</span>
          </h1>
          <p className="mt-4 text-sm min-[680px]:text-base">
            {name ? <>Thank you, <b className="text-[#78b82e]">{name}</b>.</> : "Thank you."} Your player registration has been received.
          </p>
          {playerId && (
            <p className="mt-4 rounded-lg border border-[#78b82e]/70 bg-[#031320]/80 px-6 py-3 text-sm">
          ...
          <Link className="mt-8 rounded-lg bg-[linear-gradient(135deg,#82bd36,#57971e)] px-8 py-4 text-sm font-bold" href="/">
            BACK TO HOME
          </Link>
        </div>
      </div>
